...
export function buildEmailHtml({
  ...
  const telefonoBlock = telefono
    ? `<p style="margin:18px 0 0;font-size:14px;line-height:1.5;color:#3a3228;font-family:system-ui,sans-serif;">Teléfono de contacto (opcional): <strong>${esc(
        telefono
      )}</strong></p>`
    : '';
